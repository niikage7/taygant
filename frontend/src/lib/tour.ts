...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    text: "Слева — рабочие экраны: диаграмма Ганта, канбан-доска, обзор с метриками, карточка задачи, команда и мастер создания проекта.",
  },
  {
    id: "project",
  ...
  },
  {
    ...
    href: "/board",
    title: "Канбан-доска",
    text: "Те же задачи без графика — по колонкам План, В работе и Завершены. Перетащите карточку в другую колонку, и статус задачи сменится. Просроченные и заблокированные отмечены бейджем.",
  },
  {
    id: "create",
    target: "create-task",
